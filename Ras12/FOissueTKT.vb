...
Public Class FOissueTKT
    ...
    Public Sub New(ByVal parAction As String)
        ...
        For i = 0 To tblTkt.Rows.Count - 1
            If DefineDomRtg(pstrVnDomCities, tblTkt.Rows(i)("Itinerary")) <> "DOM" Then
                mblnIntl = True
                Exit For
            End If
        Next
    ...
    Private Sub CmdAddTKT_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CmdAddTKT.Click
        ...
        If CmbDocType.Text = "ETK" Then
            Dim strDomCities As String = DefineDomRtg(pstrVnDomCities, txtRTG.Text)
    ...
    Private Sub GridFOP_CellEnter(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles GridFOP.CellEnter
        ...
        ElseIf e.ColumnIndex = 2 Then
            ...
            If isIATARate Then
                varROE = IIf(varCurr = "VND", 1, ForEX_12(Me.TxtDOS.Value, varCurr, IIf(BasedCurr = "VND", "BBR", "BSR"), "IATA").Amount)
            Else
                varROE = IIf(varCurr = "VND", 1, ForEX_12(Me.TxtDOS.Value, varCurr _
...
ErrorHandler:
    ...
    Private Sub CmbCurr_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles CmbCurr.LostFocus, CmbCurr.TextChanged
        ...
        If cmb.Text = "VND" Then
            objRoe.Amount = 1
        Else
            objRoe = ForEX_12(Me.TxtDOS.Value, cmb.Text, "BSR", MySession.TRXCode)
        End If
        If cmb.Name = "CmbCurr" Then
    ...
    Private Sub XacDinhLaiTiGia()
        ...
        If DefineBSPStock() And pubVarSRV = "S" And Not isFromTKTList And mRCP = "" Then
            isIATARate = True
            Dim objROE As New clsROE
            objROE = ForEX_12(Me.TxtDOS.Value, "USD", "BSR", "IATA")
    ...
    Private Function inValidVCR(ByVal VCRNo As String, ByVal pCurr As String _
        ...
        tblVcr = GetDataTable("select Amount,Territory,SVC,MAX_OB,KickBack from discountVCR where status+curr ='OK" & _
...
errHandler:
    ...
    Private Sub CmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CmdSave.Click
        ...
        If pubVarSRV <> "V" And CDec(Me.txtNettPayable.Text) <> 0 Then
            If (Me.CmbCurr.Text = "USD" And CDec(Me.txtNettPayable.Text) > 64000) Or _
    ...
    Private Function SaveInput(ByVal varStatus As String) As Boolean
        ...
        Else
            ROEID = ForEX_12(Me.TxtDOS.Value, "USD", "RECID", MySession.TRXCode).Amount
        End If
...
KoTimThay:
    ...
    Private Sub CmAL_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CmbAL.SelectedIndexChanged
        ...
        Me.StatusCounter.Text = " Counter: " & MySession.Domain & "/" & MyAL.ALCode
        Dim objRoe As clsROE = ForEX_12(Me.TxtDOS.Value, "USD", "BSR", MySession.TRXCode)
        Me.LcktxtROE.Text = Format(objRoe.Amount, "#,##0.00")
    ...
    Private Function LogicCheckOK() As Boolean
        ...
        If CmbDocType.Text = "HTL" AndAlso Not TxtBkgClass.Text.Contains("/") Then
            ...
            Return False
        ElseIf CmbDocType.Text = "ETK" Then
            ...
            For Each strFb As String In arrFBs
                ...
                End If
            Next
        ElseIf CmbDocType.Text = "ATK" Then
            If txtRTG.Text.Length < 10 Then
                MsgBox("Itinerary is TOO SHORT! ")
                Return False
            End If
        End If
        Return True
